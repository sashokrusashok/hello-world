...
__attribute__((section("__versions"))) = {
	...
	{ 0xc6c6c01b, __VMLINUX_SYMBOL_STR(nf_unregister_net_hook) },
	{ 0x6149cf19, __VMLINUX_SYMBOL_STR(nf_register_net_hook) },
...
MODULE_INFO(srcversion, "D8CB0BB18D423559489D456");
